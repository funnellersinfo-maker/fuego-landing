...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      {
        id: "salchipapas",
        name: "Salchipapas FUEGO",
        description: "Papas fritas doradas con salchicha colombiana cortada, salsa rosa, salsa de queso y chispas de bacon.",
        price: 16000,
        image: "/menu-salchipapas.png",
        ingredients: ["Papas fritas", "Salchicha colombiana", "Salsa rosa", "Salsa de queso", "Bacon"],
        isNew: false,
        isPopular: true,
      },
      {
        id: "mazorcada",
        name: "Mazorcada",
        description: "Mazorca desgranada con mantequilla, queso costeño gratinado, salsa rosada y un toque de limón.",
        price: 12000,
        image: "/menu-mazorcada.png",
        ingredients: ["Mazorca desgranada", "Mantequilla", "Queso costeño", "Salsa rosada", "Limón"],
        isNew: true,
        isPopular: true,
      },
      {
        id: "choriperro",
        name: "Choriperro",
        description: "Perro caliente con chorizo colombiano, papas trituradas, queso fundido, salsas y lechuga.",
        price: 15000,
        image: "/menu-choriperro.png",
        ingredients: ["Chorizo colombiano", "Papas trituradas", "Queso fundido", "Salsas", "Lechuga"],
        isNew: true,
        isPopular: true,
      },
    ],
    ...
    items: [
      {
        id: "gaseosas",
        name: "Gaseosa",
        description: "Coca-Cola, Postobón, Sprite o Fanta. Bien fría, 400ml.",
        price: 5000,
        image: "/menu-gaseosas.png",
        ingredients: ["Gaseosa 400ml"],
        isNew: false,
        isPopular: true,
      },
      {
        id: "jugos",
        name: "Jugo Natural",
        description: "Jugos naturales de fruta colombiana: lulo, maracuyá, mora, guanábana o mango. 500ml.",
        price: 7000,
        image: "/menu-jugos.png",
        ingredients: ["Fruta natural 100%", "Agua", "Panela opcional"],
        isNew: true,
        isPopular: true,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: 55000,
        image: "/menu-combo-parrillero.png",
